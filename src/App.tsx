            ...
            <section className="flex-1 p-4 md:p-8 md:pl-72 pt-16 md:pt-20 min-h-screen">
              {crmRole === 'super_admin' ? (
                ...
                <SuperAdminViews
                  ...
                  services={services}
                  packages={packages}
                  settings={settings || { appName: 'AQ8 Algérie', contactEmail: 'aq8algerie@gmail.com', contactPhone: '+213 795 12 84 09', addressAlgérie: 'Hydra, Alger', currency: 'DZD', enableVoucherPromo: true }}
