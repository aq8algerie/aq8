...
export const INITIAL_CENTERS: Center[] = [
  {
    ...
    imageUrl: '/images/centres/aq8-birkhadem.webp',
    services: ['aq8', 'wonder'],
  ...
  },
  {
    ...
    imageUrl: '/images/centres/aq8-ouled-fayet.webp',
    services: ['aq8', 'wonder'],
  ...
  },
  {
    ...
    imageUrl: '/images/centres/aq8-tlemcen.webp',
    services: ['aq8', 'wonder'],
  ...
  },
  {
    ...
    name: 'AQ8 Draria',
    city: 'Alger',
    address: 'Cité 142 logts, Draria 16000, Algérie',
    phone: '0770397387',
    email: 'wonderaq8@gmail.com',
    imageUrl: '/images/centres/aq8-draria.webp',
    services: ['aq8', 'wonder'],
    schedule: 'Samedi - Jeudi : 08:00 - 18:00 | Vendredi : Fermé',
    description: 'Centre AQ8 Draria pour vos séances AQ8 EMS et Wonder, avec une capacité adaptée par heure et une équipe dédiée.',
    slug: 'draria',
    status: 'Ouvert',
    importantNotes: [
      'Ouvert de 8h à 18h du samedi au jeudi, fermé le vendredi.',
      'Localisation GPS : AQ8 Draria.',
      'Gérante : Mme Yasmina Ikhlef - +213 560933133.',
      'Vous devez prendre vos rendez-vous LA VEILLE avant 21h30 (pas le jour même).',
      'Les réservations se font par heure complète (Ex : de 10h à 11h, et non de 10h30 à 11h30).',
      'Il peut y avoir un décalage de votre rendez-vous dû au fuseau horaire, mais l’heure sélectionnée reste la référence.',
      'IMPORTANT : Vous devez recevoir votre reçu de paiement directement au centre pour valider votre paiement.'
    ],
...
export const INITIAL_SETTINGS: GeneralSettings = {
  appName: 'AQ8 Algérie',
  contactEmail: 'aq8algerie@gmail.com',
