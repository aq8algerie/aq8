...
function BlogHero({ onSelectCategory }: { onSelectCategory: (cat: BlogCategory | "all") => void }) {
  return (
    <section className="relative isolate min-h-[460px] overflow-hidden rounded-3xl bg-[#0d0d11] text-white shadow-2xl border border-white/10 sm:min-h-[500px]">
      ...
      <div className="pointer-events-none absolute -left-20 -top-20 h-96 w-96 rounded-full bg-[#ff5757]/20 blur-[120px]" />
      ...
      <div className="relative z-10 flex min-h-[460px] max-w-4xl flex-col justify-center px-6 py-12 sm:min-h-[500px] sm:px-12 sm:py-16 lg:px-16">
        {/* Shimmer Badge */}
        <div className="mb-5 inline-flex w-fit items-center gap-2.5 rounded-full border border-[#ff5757]/40 bg-[#ff5757]/10 px-4 py-1.5 backdrop-blur-md">
          ...
          <span className="text-xs font-black uppercase tracking-wider text-[#ff7777]">
        ...
        <h1 className="font-display text-4xl font-extrabold leading-tight tracking-tight text-white sm:text-5xl lg:text-6xl">
          Conseils, Science & <br />
          <span className="bg-gradient-to-r from-[#ff7777] via-[#ff5757] to-amber-300 bg-clip-text text-transparent">
        ...
        <div className="mt-8 flex flex-wrap gap-2.5 sm:gap-3 text-xs font-semibold text-slate-300">
          ...
          <div className="inline-flex items-center gap-1.5 rounded-lg border border-white/10 bg-white/5 px-3 py-1.5 backdrop-blur-md">
            <Activity className="h-3.5 w-3.5 text-[#ff5757]" />
        ...
        <div className="mt-8 flex flex-wrap items-center gap-4">
          <a
            href="#magazine-aq8"
            className="group inline-flex items-center gap-2.5 rounded-xl bg-gradient-to-r from-[#ff5757] to-[#e94949] px-6 py-3.5 text-sm font-extrabold text-white shadow-lg shadow-[#ff5757]/30 transition-all hover:scale-[1.02] hover:shadow-[#ff5757]/50"
          >
      ...
      <div className="hidden lg:block absolute right-12 top-1/2 -translate-y-1/2 w-80 rounded-2xl border border-white/15 bg-white/10 p-6 backdrop-blur-xl shadow-2xl">
        <div className="flex items-center gap-3 border-b border-white/10 pb-4">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#ff5757] to-amber-500 text-white font-black text-sm">
            AQ8
          </div>
          <div>
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="flex items-center gap-2 font-display text-xl font-bold text-[#242424]">
          <Layers className="h-5 w-5 text-[#ff5757]" />
          Thématiques & Formats
        </h2>
          ...
          return (
            <button
              ...
              className={`group relative flex flex-col justify-between rounded-2xl p-4 text-left transition-all duration-300 ${
                isSelected
                  ? "bg-gradient-to-br from-[#242424] to-[#161618] text-white shadow-xl shadow-black/10 ring-2 ring-[#ff5757]"
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
        ...
        >
          ...
          <div className="relative h-64 w-full overflow-hidden bg-slate-900 sm:h-72">
            ...
            <div className="absolute bottom-4 left-6 right-6">
              <div className="flex flex-wrap items-center gap-2 text-[10px] font-extrabold uppercase text-white">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-[#ff5757] px-3 py-1 text-white shadow-md">
          ...
          <div className="p-6 sm:p-8 space-y-6">
            <div>
              <h3 className="text-xs font-extrabold uppercase text-[#ff5757] tracking-wider">Résumé & Aperçu</h3>
            ...
            <div className="rounded-2xl border border-rose-100 bg-rose-50/40 p-5 space-y-3">
              <h4 className="text-xs font-extrabold uppercase text-[#242424] flex items-center gap-2">
                <CheckCircle2 className="h-4 w-4 text-[#ff5757]" />
                Points clés à retenir
              </h4>
              <ul className="space-y-2 text-xs font-semibold text-slate-700">
                {post.content.slice(0, 4).map((block, idx) => (
                  <li key={idx} className="flex items-start gap-2">
                    <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-[#ff5757]" />
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 border-t border-slate-100 pt-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  ...
                  onClick={onClose}
                  className="inline-flex items-center gap-2 rounded-xl bg-[#ff5757] px-5 py-2.5 text-xs font-bold text-white shadow-md shadow-[#ff5757]/20 transition hover:bg-[#e94949]"
                >
  ...
  return (
    <div className="mt-16 space-y-12">
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#18181c] via-[#242429] to-[#18181c] p-8 sm:p-12 text-white shadow-2xl border border-white/10">
        <div className="pointer-events-none absolute -right-20 -top-20 h-64 w-64 rounded-full bg-[#ff5757]/20 blur-3xl" />

        <div className="relative z-10 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div>
            <span className="inline-flex items-center gap-2 text-xs font-black uppercase text-[#ff7777] tracking-wider">
              ...
              <form onSubmit={handleSubscribe} className="space-y-3">
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-2xl border border-white/20 bg-white/10 px-5 py-4 text-sm font-medium text-white placeholder-slate-400 backdrop-blur-md outline-none transition focus:border-[#ff5757] focus:ring-2 focus:ring-[#ff5757]/30"
                  />
                </div>
                <button
                  type="submit"
                  className="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-[#ff5757] px-6 py-4 text-sm font-extrabold text-white shadow-lg shadow-[#ff5757]/30 transition hover:bg-[#e94949]"
                >
      ...
      <section className="rounded-3xl border border-slate-200/80 bg-white p-6 sm:p-10 shadow-lg">
        <div className="flex items-center justify-between border-b border-slate-100 pb-6">
          <div>
            <span className="text-xs font-black uppercase text-[#ff5757] tracking-wider">Expertise & Réponses</span>
            <h2 className="mt-1 font-display text-2xl font-bold text-[#242424] sm:text-3xl">
              Questions Fréquentes avant votre Séance
            </h2>
          </div>
          <HelpCircle className="h-8 w-8 text-[#ff5757] opacity-80 hidden sm:block" />
        </div>
            ...
            return (
              <div key={index} className="py-4">
                <button
                  ...
                  className="flex w-full items-center justify-between text-left text-base font-bold text-[#242424] transition hover:text-[#ff5757]"
                >
                  <span>{faq.q}</span>
                  <ChevronDown className={`h-5 w-5 shrink-0 text-slate-400 transition-transform ${isOpen ? "rotate-180 text-[#ff5757]" : ""}`} />
                </button>
                <AnimatePresence>
                  {isOpen && (
                    <motion.div
    ...
    <div className="space-y-12 pb-12" suppressHydrationWarning>
          ...
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] lg:items-stretch">
            <div className="flex flex-col justify-center p-8 sm:p-12 lg:p-14">
              <div className="flex items-center gap-2 mb-4">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-rose-50 px-3.5 py-1 text-xs font-black uppercase text-[#ff5757]">
              ...
              <Link href={"/conseils/" + featured.slug} className="group">
                <h2 className="font-display text-3xl font-bold leading-tight text-[#242424] transition group-hover:text-[#ff5757] sm:text-4xl">
                  {featured.title}
                </h2>
              </Link>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs font-semibold text-slate-500">
                <span className="inline-flex items-center gap-1.5">
                  <CalendarDays className="h-3.5 w-3.5 text-[#ff5757]" />
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-[#242424] px-6 py-3 text-sm font-bold text-white transition hover:bg-[#ff5757]"
                >
                ...
                >
                  <Eye className="h-4 w-4 text-[#ff5757]" />
      ...
      <section className="space-y-6">
        <div className="flex flex-col gap-4 border-b border-slate-200 pb-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <span className="text-xs font-black uppercase text-[#ff5757] tracking-wider">Tous les articles</span>
            <h2 className="mt-1 font-display text-2xl font-bold text-[#242424] sm:text-3xl">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="relative flex-1 sm:w-72">
              ...
              <input
                ...
                className="h-11 w-full rounded-xl border border-slate-200 bg-white pl-10 pr-9 text-xs font-semibold text-[#242424] outline-none transition focus:border-[#ff5757] focus:ring-2 focus:ring-[#ff5757]/20"
              />
              {search && (
                <button
                  type="button"
            ...
            <select
              ...
              className="h-11 rounded-xl border border-slate-200 bg-white px-3 text-xs font-bold text-slate-700 outline-none transition focus:border-[#ff5757]"
            >
          ...
          <div className="rounded-3xl border border-dashed border-slate-300 bg-slate-50 p-10 text-center">
            ...
            {posts.length > 1 && (
              <button
                ...
                className="mt-4 inline-flex items-center gap-2 rounded-xl bg-[#242424] px-5 py-2.5 text-xs font-bold text-white transition hover:bg-[#ff5757]"
              >
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {remainingPosts.map((post) => {
              ...
              return (
                <article
                  key={post.id}
                  className="group flex flex-col justify-between overflow-hidden rounded-3xl border border-slate-200/80 bg-white shadow-md transition duration-300 hover:-translate-y-1 hover:border-[#ff5757]/40 hover:shadow-xl"
                >
                  ...
                  <div>
                    ...
                    <div className="p-6 space-y-3">
                      ...
                      <Link href={"/conseils/" + post.slug}>
                        <h3 className="line-clamp-2 font-display text-xl font-bold leading-snug text-[#242424] transition group-hover:text-[#ff5757]">
                          {post.title}
                        </h3>
                      </Link>
                  ...
                  <div className="border-t border-slate-100 p-6 pt-4 flex items-center justify-between text-xs font-semibold">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        title="Aperçu rapide"
                        className="flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 bg-slate-50 text-slate-600 transition hover:bg-rose-50 hover:text-[#ff5757]"
                      >
                        <Eye className="h-4 w-4" />
                      </button>
                      <Link
                        href={"/conseils/" + post.slug}
                        className="inline-flex items-center gap-1 font-bold text-[#242424] transition group-hover:text-[#ff5757]"
                      >
                        <span>Lire</span>
